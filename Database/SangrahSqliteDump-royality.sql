...
CREATE TABLE `vtiger_contactroyality` (`royalityid` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL ,`contactid` INT  NOT NULL DEFAULT 0,`royalitynumber` VARCHAR(100)  NOT NULL ,`royalitycount` INT  NOT NULL DEFAULT 0);
...
CREATE TABLE `vtiger_royality` (`royalityid` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL ,`royality_count` INT  NOT NULL DEFAULT 0,`royalityamount` FLOAT(19,2)  NOT NULL DEFAULT 0,`from_date` DATE  NULL DEFAULT NULL,`to_date` DATE  NULL DEFAULT NULL,`deleted` SMALLINT  NOT NULL DEFAULT 0);

CREATE TABLE `vtiger_royality_amount` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL ,`royality_count` INT  NOT NULL DEFAULT 0,`royalityamount` FLOAT(19,2)  NOT NULL DEFAULT 0,`from_date` DATE  NULL DEFAULT NULL,`to_date` DATE  NULL DEFAULT NULL);
...
CREATE TABLE `vtiger_salesman` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL ,`userid` INT  NOT NULL DEFAULT 0,`invoiceid` INT  NOT NULL DEFAULT 0,`amount` FLOAT(19,2)  NOT NULL DEFAULT 0,`date` DATE  NULL DEFAULT NULL);
