...
/**
 * VtigerWarehousestoreInventorytransaction generated by hbm2java
 */
public class VtigerWarehousestoreInventorytransaction
		implements
			java.io.Serializable {

	private int warehousestoreTransactionId;
	private String date;
	private Integer warehousestoreId;
	...
	public VtigerWarehousestoreInventorytransaction() {
	}

	public VtigerWarehousestoreInventorytransaction(
			int warehousestoreTransactionId, int challanQtySent,
			int challanQtyReceive) {
		this.warehousestoreTransactionId = warehousestoreTransactionId;
		this.challanQtySent = challanQtySent;
		this.challanQtyReceive = challanQtyReceive;
	}

	public VtigerWarehousestoreInventorytransaction(
			int warehousestoreTransactionId, String date,
			Integer warehousestoreId, String barcode, Integer productid,
			String productName, Integer openingStockQty, String openingCost,
			...
			String cstwithoutcformAmt, Integer invoiceId, String invoiceNo,
			Integer salesQty, String salesCost, Integer purchaseReturnQty,
			String purchaseReturnCost, Integer salesretId,
			Integer salesReturnQty, String salesReturnCost,
			Integer adjustmentQty, String adjustmentCost, Integer challanId,
			String challanNo, int challanQtySent, int challanQtyReceive,
			Integer closingStock, Integer finalStock, String unitprice,
			String vat, Integer vendorId) {
		this.warehousestoreTransactionId = warehousestoreTransactionId;
		this.date = date;
	...
	public VtigerWarehousestoreInventorytransaction(int warehousestoreTransactionId, String date,
			Integer warehousestoreId, Integer productid, String productName,
			Integer openingStockQty, String openingCost, Integer invoiceId,
			String invoiceNo, Integer salesQty, String salesCost,
			Integer closingStock, String unitprice) {
		this.warehousestoreTransactionId = warehousestoreTransactionId;
		this.date =date;
		this.warehousestoreId = warehousestoreId;
		this.productid = productid;
	...
	public int getWarehousestoreTransactionId() {
		return this.warehousestoreTransactionId;
	}

	public void setWarehousestoreTransactionId(int warehousestoreTransactionId) {
		this.warehousestoreTransactionId = warehousestoreTransactionId;
	}
	...
	public Integer getWarehousestoreId() {
		return this.warehousestoreId;
	}

	public void setWarehousestoreId(Integer warehousestoreId) {
		this.warehousestoreId = warehousestoreId;
	}
