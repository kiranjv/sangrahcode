 ...
 * @see com.java.sangrah.models.VtigerContactdetails
 * @author Hibernate Tools
 */
public class VtigerContactdetailsHome {

	private static final Log log = LogFactory
			.getLog(VtigerContactdetailsHome.class);
	...
	public VtigerContactdetails merge(VtigerContactdetails detachedInstance) {
		...
		try {
			VtigerContactdetails result = (VtigerContactdetails) sessionFactory
	...
	public VtigerContactdetails findById(int id) {
		...
		try {
			VtigerContactdetails instance = (VtigerContactdetails) sessionFactory
					.getCurrentSession().get(
							"com.java.sangrah.models.VtigerContactdetails", id);
			if (instance == null) {
	...
	public List findByExample(VtigerContactdetails instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.java.sangrah.models.VtigerContactdetails")
