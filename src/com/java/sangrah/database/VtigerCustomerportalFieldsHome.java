...
import com.java.sangrah.models.VtigerCustomerportalFields;
import com.java.sangrah.models.VtigerCustomerportalFieldsId;

/**
 * Home object for domain model class VtigerCustomerportalFields.
 * @see com.java.sangrah.models.VtigerCustomerportalFields
 * @author Hibernate Tools
 */
public class VtigerCustomerportalFieldsHome {

	private static final Log log = LogFactory
			.getLog(VtigerCustomerportalFieldsHome.class);
	...
	public VtigerCustomerportalFields merge(
			VtigerCustomerportalFields detachedInstance) {
		log.debug("merging VtigerCustomerportalFields instance");
		try {
			VtigerCustomerportalFields result = (VtigerCustomerportalFields) sessionFactory
	...
	public VtigerCustomerportalFields findById(
			com.java.sangrah.models.VtigerCustomerportalFieldsId id) {
		log.debug("getting VtigerCustomerportalFields instance with id: " + id);
		try {
			VtigerCustomerportalFields instance = (VtigerCustomerportalFields) sessionFactory
					.getCurrentSession()
					.get("com.java.sangrah.models.VtigerCustomerportalFields",
							id);
			if (instance == null) {
	...
	public List findByExample(VtigerCustomerportalFields instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.java.sangrah.models.VtigerCustomerportalFields")
